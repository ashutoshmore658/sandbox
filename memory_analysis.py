...
class Memory:
    ...
    def getMemForensics(self,vol_plugin):
        c_proc=subprocess.Popen([interpreter,voltility,"-f",mem_dump,"-s",mem_profile,vol_plugin],stdout=subprocess.PIPE)
        proc_op=(c_proc.communicate()[0]).decode()
        return proc_op
    def getBanners(self):
        plugin="banners.Banners"
        proc_op=getMemForensics(plugin)
        banners=proc_op.split("\n")[4:-1]
        offset_and_banners=[]
        for banner in banners:
            offset_and_banners.append(banner.split("\t"))
        return offset_and_banners
    ...
    def getProcessesWithEnvVars(self):
        ...
        return res_processes_with_env_vars
    ...
    def getLoadedKernelModules(self):
        ...
        return res_loaded_kernel_modules
    def getMemoryMapsOfProcesss(self):
        ...
        return res_memory_maps_of_processes
    def getProcessesWithPotentiallyInjectedCode(self):
        ...
        return res_processes_with_potentially_injected_codes
    def getProcessesMountSpaces(self):
        ...
        return res_processes_mount_spaces
    ...
    def getprocessesWithCommands(self):
        ...
        return res_processes_with_commands
